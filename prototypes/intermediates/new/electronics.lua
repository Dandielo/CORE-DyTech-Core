...
{
    {
        ...
        icon = "__dytech-core__/graphics/intermediates/tech/advanced-cables.png",
    ...
    {
        templates = { "science-red", "science-green", "science-blue" },
        icon = "__dytech-core__/graphics/intermediates/tech/advanced-processing-unit.png",
    ...
    {
        templates = { "science-red", "science-green", "science-blue" },
        icon = "__dytech-core__/graphics/intermediates/tech/logic-diamond-processor.png",
