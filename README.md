DyTech - Core [![build status](http://git.dandielo.net/ci/projects/3/status.png?ref=master)](https://github.com/Dandielo/CORE-DyTech-Core)
======
...
Builds
=
Valid builds can be found under the 'Piplines' tab. 



Warning:
=
- DO NOT USE GITHUB SOURCE BUILDS! THE SOURCE MIGHT CONTAIN BUGS AND HAVE UNFINISHED FEATURES!
